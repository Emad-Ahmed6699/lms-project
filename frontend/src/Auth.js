                    ...
                    {authPage === "login" ? (
                        <form onSubmit={(e) => { e.preventDefault(); handleLogin(); }}>
                            ...
                            <div className="auth-footer">
                                Don’t have an account? <button className="link-btn" onClick={() => setAuthPage("register")}>Create account</button>
                            </div>
                        </form>
                    ) : (
                        <form onSubmit={(e) => { e.preventDefault(); handleRegister(); }}>
                            ...
                            <div className="auth-footer">Already have an account? <button className="link-btn" onClick={() => setAuthPage('login')}>Sign in here</button></div>
                        </form>
                    )}

                    <div className="test-account-info">Test accounts: emad / emad123 or admin / admin123</div>
                </div>
            </div>
        </div>
    );
